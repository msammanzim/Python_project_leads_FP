...
class sms_path():
    ...
    def userprofile(self):
        #user id
        driver.find_element(By.XPATH,value="//input[@id='LoginId']").send_keys("a3223")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@name='userProfileName']").click()
        time.sleep(2)
        #USER NAME
        driver.find_element(By.XPATH,value="//input[@name='userProfileName']").send_keys("Hasan")
        time.sleep(3)
        ...
        time.sleep(2)
        #Branch Office
        driver.find_element(By.NAME,value="HomeBranchId").click()
        time.sleep(1)
        dropdown = driver.find_element(By.XPATH, "//select[@name='HomeBranchId']")
        levelname = 'Dhaka Bank (3223)'
