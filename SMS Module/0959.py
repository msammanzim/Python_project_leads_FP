...
class sms_path():
    ...
    def user_info(self):
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@name='LoginId']").send_keys("b3224")
        time.sleep(2)
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@name='CashCounterLimit']").send_keys("999999999")
        time.sleep(1)
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@name='TranDrPassingLimit']").send_keys("99999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@name='TranCrPassingLimit']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@name='TranCrPassingLimit']").send_keys("99999999")
        time.sleep(1)
