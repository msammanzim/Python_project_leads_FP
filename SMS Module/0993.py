...
#Bank Office Id
        ...
        time.sleep(2)
        driver.find_element(By.XPATH,value="//input[@ng-model='BankOffice.frmObj.BankOfficeId']").send_keys('3225')
        time.sleep(2)
#Full Name
        driver.find_element(By.XPATH,value="//input[@ng-model='BankOffice.frmObj.BankOfficeFullName']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@ng-model='BankOffice.frmObj.BankOfficeFullName']").send_keys("Dhaka")
        time.sleep(1)
#short name
...
#Adress
        ...
        press("down")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@class='form-control ls-control ng-pristine ng-untouched ng-empty ng-valid-minlength ng-valid-maxlength ng-invalid ng-invalid-required']").send_keys("299522552")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@ng-model='BankOffice.frmObj.SBS']").send_keys("2528")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@ng-model='BankOffice.frmObj.ADFX']").send_keys("2528")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@ng-model='BankOffice.frmObj.CBCTR']").send_keys("2528")
        time.sleep(1)
