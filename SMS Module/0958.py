...
class sms_path():
    ...
    def user_info(self):
        ...
        press("backspace")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount1']").send_keys('99999999')
        time.sleep(5)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount2']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount2']").send_keys("99999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount11']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount11']").send_keys("99999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount12']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount12']").send_keys("999999999")
        time.sleep(1)
        for _ in range(3):
            press('Down')
            time.sleep(1)
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount5']").send_keys("9999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount6']").click()
        time.sleep(1)
        driver.find_element(By.XPATH, value="//input[@id='AmountLimits.frmObj.LimitAmount6']").send_keys("99999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount9']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount9']").send_keys("999999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount10']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount10']").send_keys("99999999")
        time.sleep(1)
        for _ in range(3):
            press('Down')
            time.sleep(1)
        ...
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount13']").send_keys("999999999")
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount14']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount14']").send_keys("999999999")
        time.sleep(2)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount16']").click()
        time.sleep(1)
        driver.find_element(By.XPATH,value="//input[@id='AmountLimits.frmObj.LimitAmount16']").send_keys("999999999")
        time.sleep(1)
